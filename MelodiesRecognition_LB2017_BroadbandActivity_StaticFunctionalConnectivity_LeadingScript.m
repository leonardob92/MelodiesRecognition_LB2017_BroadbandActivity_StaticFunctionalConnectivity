%% PAPER "Spatiotemporal whole-brain activity and functional connectivity of melodies recognition" - LEONARDO BONETTI
...
%#4
%Finally, please note that some parts of the code provided here (e.g. Dynamic
%Functional Connectivity (DFC)) were not used in the associated paper published
%in Cerebral Cortex. However, I decided not to remove them, since they might
